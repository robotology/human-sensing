...
bool FACEModule::configure(yarp::os::ResourceFinder &rf)
{
    ...
    predictorFile = rf.check("landmarksPath", yarp::os::Value("shape_predictor_68_face_landmarks.dat"), "path name (string)").asString();
    ...
    faceManager = new FACEManager( moduleName, predictorFile, cntxHomePath );
